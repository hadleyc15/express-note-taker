# Express Note Taker
  ...
  * [Questions](#questions)
  ...
  An express.js application to allow a user to write and save notes to allow them to organize their thoughts and keep track of tasks that they need to complete.
